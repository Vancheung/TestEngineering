'''
version 4: Quick Union + path compression, keep tree almost completely flat
O(union): depth of tree = lg*(N)
O(connected): lg*(N)  (iterated log function)
N               lg*(N)
1               0
2               1
4               2
...
# root(int i): make every other node in path point to its grandparent
